                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-black">{restaurant.rating?.toFixed(0) || "New"}</span>
                      </div>
                    </div>
                      ...
                      <div className="mt-2 flex flex-wrap gap-1">
                        {Array.isArray(restaurant.cuisine) ? (
                          restaurant.cuisine.slice(0, 3).map((type) => (
                            <span
                              key={type}
                              className="px-3 py-1 bg-gray-100 rounded-full text-md text-gray-800 border border-slate-300"
                            >
                              {type}
                            </span>
                          ))
                        ) : (
                          <span className="px-3 py-1 bg-gray-100 rounded-full text-md text-gray-800 border border-slate-300">
                            {restaurant.cuisine}
                          </span>
                        )}
                      </div>
